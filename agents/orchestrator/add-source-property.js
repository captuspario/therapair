...
// Read .env manually since we might not have dotenv installed yet in this context
...
console.log(`Adding 'Source' property to User Testing DB: ${DATABASE_ID}...`);
